...
export default function BusApplicationComplete() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && window.dataLayer) {
      window.dataLayer.push({
        'event': 'form_complete',
        'form_name': 'ridejob_bus_application'
      });
    }
  }, []);
      ...
      <main className="flex flex-1 flex-col pb-12">
        ...
        <section className="mt-12">
          ...
          <div className="px-4">
            ...
            <div className="mt-6">
              <BookingEmbed slug="ride" height={1300} />
            </div>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className="px-4">
            ...
            <p className="mt-4 text-lg leading-relaxed text-gray-900">
              日本全国の移動を作り出すことを目指して、バス業界に特化した転職エージェント事業を行っています。
            </p>
          </div>
          ...
          <div className="bg-[#9CCAF5] p-4">
            <div className="rounded-xl bg-white px-6 py-8 shadow-[0_10px_25px_rgba(34,5,217,0.12)]">
              ...
              <div className="mt-6 space-y-5 text-[15px] leading-relaxed text-gray-900">
                ...
                <p>
                  バス運転手は自分の頑張り次第で売上につながる仕事なので、やりがいを感じています。
                </p>
                <p>
        ...
        {!isLoadingJobs && jobs.length > 0 && (
          <section className="mt-12 px-4">
            ...
            <div className="px-2 text-sm leading-relaxed text-gray-700">
              <p className="mt-6">
                {new Date().toLocaleDateString('ja-JP', { month: 'long', day: 'numeric' })}現在、バス求人への問合せが殺到しています。
              </p>
